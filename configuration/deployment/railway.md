---
description: Learn how to deploy TROM.AI on Railway
---
...
That's it! You now have a deployed TROM.AI on Railway [🎉](https://emojipedia.org/party-popper/)[🎉](https://emojipedia.org/party-popper/)

## Persistent Volume

The default filesystem for services running on Railway is ephemeral. TROM.AI data isn’t persisted across deploys and restarts. To solve this issue, we can use [Railway Volume](https://docs.railway.app/reference/volumes).
...
* DATABASE\_PATH - `/opt/railway/.tromai`
* APIKEY\_PATH - `/opt/railway/.tromai`
* LOG\_PATH - `/opt/railway/.tromai/logs`
* SECRETKEY\_PATH - `/opt/railway/.tromai`
* BLOB\_STORAGE\_PATH - `/opt/railway/.tromai/storage`
