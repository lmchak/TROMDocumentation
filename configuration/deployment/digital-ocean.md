---
description: Learn how to deploy TROM.AI on Digital Ocean
---
...
4. _(Optional)_ You can also specify `TROMAI_USERNAME` and `TROMAI_PASSWORD` for app level authorization. See more [broken-reference](broken-reference/ "mention")
...
server {
    listen 80;
    listen [::]:80;
    server_name your_domain; #Example: demo.tromAI.com
    location / {
...
You have successfully setup TROM.AI on your Droplet, with SSL certificate on your domain [🥳](https://emojipedia.org/partying-face/)

## Steps to update TROM.AI on Digital Ocean

1. Navigate to the directory you installed tromai in
...
3. Pull the latest TROM.AI Image

You can check the latest version release [here](https://github.com/TROM.AI/TROM.AI/releases)
