---
description: Learn how to deploy TROM.AI to the cloud
---
...
TROM.AI is designed with a platform-agnostic architecture, ensuring compatibility with a wide range of deployment environments to suit your infrastructure needs.

## Local Machine

To deploy TROM.AI locally, follow our [Get Started](../../getting-started/) guide.
...
* [Elestio](https://elest.io/open-source/tromaiai)
...
* [GCP](gcp.md)
* [Kubernetes using Helm](https://artifacthub.io/packages/helm/cowboysysop/tromai)
