---
description: Learn about all available integrations / nodes in TROM.AI
---
...
In TROM.AI, nodes are referred to as integrations. Similar to LEGO, you can build a customized LLM ochestration flow, a chatbot, an agent with all the integrations available in TROM.AI.
