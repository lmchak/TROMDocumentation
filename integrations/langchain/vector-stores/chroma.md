...
If you are running both TROM.AI and Chroma on Docker, there are additional steps involved.
...
2. Open `docker-compose.yml` in TROM.AI
...
services:
    tromai:
        ...
        environment:
            ...
            - TROMAI_SECRETKEY_OVERWRITE=${TROMAI_SECRETKEY_OVERWRITE}
            - LOG_PATH=${LOG_PATH}
            - LOG_LEVEL=${LOG_LEVEL}
        ...
        networks:
            - tromai_net
        command: /bin/sh -c "sleep 3; tromai start"
networks:
    tromai_net:
        name: chroma_net
        external: true
...
4. Spin up TROM.AI docker image
